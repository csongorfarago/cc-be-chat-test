...
var _serverTest = _interopRequireDefault(require("tests/serverTest"));
...
server.on('connection', function connection(socket) {
  ...
  clients[socket.id] = client; //sending chat history

  socket.send("03" + JSON.stringify(messages)); //Handle messages from clients  

  socket.on('message', function incoming(message) {
    //decoding message
    var code = message.substring(0, 2);
    var data = JSON.parse(message.substring(2));
    console.log('received:{ code: ' + code + ' , message: ' + JSON.stringify(data) + ' }'); //Code 01 - client settings
    ...
    if (code == "02") {
      ...
      messages.push(message); //sending message object to everyone
...
console.log("Chat server is running at localhost:" + PORT); //Helper functions
...
//# sourceMappingURL=C:\work\chat-test\node_modules\.cache\ava\f007b19b9821d1f506919877f96d8f0f.js.map