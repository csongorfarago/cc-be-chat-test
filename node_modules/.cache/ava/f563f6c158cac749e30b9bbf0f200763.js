...
_ava2.default.cb('testing message history', t => {
    var ws8 = new WebSocket('ws://localhost:8080');
    ws8.on('open', function open() {
        ws8.send('01{"name":"Spammer123"}');
        for (var i = 0; i < 100; i++) {
            ws8.send('02{"message":"spame' + i + '"}');
        }
    });
    ws8.on('message', function incoming(message) {
        console.log(message);
    });
});
//# sourceMappingURL=..\node_modules\.cache\ava\f563f6c158cac749e30b9bbf0f200763.js.map